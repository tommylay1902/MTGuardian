...
func (m *MockAuthDAO) CreateAuth(auth *model.Auth) (*uuid.UUID, error) {
	args := m.Called(auth)
...
func MatchAuthExceptWithEmail(auth *model.Auth) interface{} {
	return mock.MatchedBy(func(arg *model.Auth) bool {
...
func TestAuthServiceLogin(t *testing.T) {
	...
	service := service.AuthService{DAO: dao}
...
func TestRefresh(t *testing.T) {
	...
	accessTokenObject := &model.AccessToken{AccessToken: validAccessToken}
